...
tk = Tk()
tk.geometry('650x750')
tk.title("PracticePresentSimpleTense")

lbl = Label(tk, text="Put the words in correct form:", font=("",16))
lbl.grid(column=0, row=0)
lbl.pack()

lbl1 = Label(tk, text="I (be) _______ sixteen years old. ", font=("",12))
lbl1.pack()
...
lbl2 = Label(tk, text="Juana (cook) _______ dinner for her family. ", font=("",12))
lbl2.pack()
...
def qwertt2():
    e=edit2.get()
    lbl2change.config(text=(e,"/cooks"))
...
lbl3 = Label(tk, text="They (eat) _______ lunch at 12:00 ", font=("",12))
lbl3.pack()
...
lbl4 = Label(tk, text="Nina (take) _______ medicine when she is sick", font=("",12))
lbl4.pack()
...
def qwertt4():
    e=edit4.get()
    lbl4change.config(text=(e,"/takes"))
...
##
##
lbl5 = Label(tk, text="He (drive) _______ a nice car", font=("",12))
lbl5.pack()
...
def qwertt5():
    e=edit5.get()
    lbl5change.config(text=(e,"/drives"))
edit5=Entry(tk,width=20,bg='white')
edit5.pack()    

##
##
lbl6 = Label(tk, text=" They (study) _______ English at school.", font=("",12))
lbl6.pack()
...
def qwertt6():
    e=edit6.get()
    lbl6change.config(text=(e,"/study"))
...
lbl8 = Label(tk, text="Tommy (live) _______ at 107 Pine Lane. ", font=("",12))
lbl8.pack()
...
def qwertt8():
    e=edit8.get()
    lbl8change.config(text=(e,"/lives"))
...
def qwertt9():
    e=edit9.get()
    lbl9change.config(text=(e,"/like"))
edit9=Entry(tk,width=20,bg='white')
edit9.pack()   
    
##
##
lbl10 = Label(tk, text=" When Dax (take) _______ a shower, he (wash) _______ his hair with shampoo.", font=("",12))
lbl10.pack()
...
def qwertt10():
    e=edit10.get()
    lbl10change.config(text=(e,"/takes,washes"))
